...
После заполнения базы данных (npm run seed) будут доступны следующие тестовые пользователи:
...
2. Преподаватели:
   ...
   - Пароль: teacher123
   - Роль: Преподаватель
   - Доступ: Управление своим расписанием, просмотр курсов
...
3. Студенты:
   ...
   - Пароль: student123
   - Роль: Студент
   - Доступ: Просмотр расписания, запись на курсы
